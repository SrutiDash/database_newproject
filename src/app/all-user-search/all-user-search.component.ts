...
//  new script after updating the logic for adding new user details 
...
export class AllUserSearchComponent implements OnInit {
  ...
  onSubmitNewUser(): void {
    ...
    console.log('New User:', newUser); // Simulate sending data to backend

    // Add new user to the existing list
    this.userDetails.push(newUser);
    this.dataSource.data = this.userDetails;

    // Reset the form and hide the new user form
